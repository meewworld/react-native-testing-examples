...
import {geneNavigationPropMock} from '../src/testing/mockData';
...
const navigationMock = geneNavigationPropMock();
...
it('renders correctly', async () => {
  // @ts-ignore
  useNavigation.mockImplementation(() => navigationMock);
  ...
  await waitFor(() => expect(navigationMock.navigate).toHaveBeenCalledTimes(1));
